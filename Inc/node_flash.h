#ifndef __NODE_FLASH__
#define __NODE_FLASH__
#include "main.h"
...
typedef enum {FLASH_OK=1,FLASH_NOT_OK=2,FLASH_ERROR=3,FLASH_OVER_WRITE}FlashStatusTypeDef;
class EraseWriteFlash{
	// this class for adjusting parameters for flash erase and write 
	EraseWriteFlash();
	private:
		
		unsigned int Address;
		unsigned int MemoryProgramStatus;
	...
	public: 
		...
		unsigned int TypeErase;	/*!< TypeErase: Mass erase or page erase.
                             This parameter can be a value of @ref FLASHEx_Type_Erase */
		unsigned int Banks;	/*!< Select banks to erase when Mass erase is enabled.
                             This parameter must be a value of @ref FLASHEx_Banks */    
		unsigned int PageAddress; /*!< PageAdress: Initial FLASH page address to erase when mass erase is disabled
                             This parameter must be a number between Min_Data = 0x08000000 and Max_Data = FLASH_BANKx_END 
                             (x = 1 or 2 depending on devices)*/
		unsigned int NbPages; /*!< NbPages: Number of pagess to be erased.
	...
	public:
		...
		FlashStatusTypeDef ReadFlash(EraseWriteFlash *flash, unsigned int *data_array,unsigned int lenght);
